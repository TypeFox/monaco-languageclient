...
## [6.2.0-next.1] - 2025-01-27

- Updated to `monaco-editor-wrapper@9.2.0-next.1` and `monaco-languageclient@6.2.0-next.1`. Updated all `@codingame/monaco-vscode` packages to `13.0.0`.
