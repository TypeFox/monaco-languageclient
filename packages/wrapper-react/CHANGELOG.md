...
- Update to monaco-vscode-api 9.0.x [#749](https://github.com/TypeFox/monaco-languageclient/pull/749)
  - Updated to `monaco-editor-wrapper@9.0.0-next.6` and `monaco-languageclient@6.0.0-next.6`. Updated all `@codingame/monaco-vscode` packages to `10.1.4`.
