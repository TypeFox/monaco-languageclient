...
export const MonacoEditorReactComp: React.FC<MonacoEditorProps> = (props) => {
                ...
                if (htmlContainer === null || htmlContainer.parentElement === null) {
                    ...
                    if (editorAppRef.current === undefined && !launchingRef.current) {
                        ...
                        if (editorAppRef.current.isStarting() === true || editorAppRef.current.isDisposing() === true) {
                            await Promise.all([editorAppRef.current.getStartingAwait(), editorAppRef.current.getDisposingAwait()]);
                        }
    ...
    useEffect(() => {
        ...
        if (
            !lcsManager.isStarted() &&
            (enforceLanguageClientDisposeRef.current === undefined || !enforceLanguageClientDisposeRef.current)
        ) {
