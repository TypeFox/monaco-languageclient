...
- Updated to `monaco-languageclient@10.0.0-next.0`.

## [6.12.0] - 2025-08-21

- Updated to `monaco-languageclient@9.11.0`.
- Updated all `@codingame/monaco-vscode` packages to `20.2.1`.

## [6.11.0] - 2025-08-14

- Updated to `monaco-languageclient@9.10.0`.
- Updated all `@codingame/monaco-vscode` packages to `20.1.1`.

## [6.10.0] - 2025-08-11

- Updated to `monaco-languageclient@9.9.0`.
- Updated all `@codingame/monaco-vscode` packages to `19.1.4`.

## [6.9.0] - 2025-06-24

- Updated to `monaco-languageclient@9.8.0`.
- Updated all `@codingame/monaco-vscode` packages to `18.1.0`.

## [6.8.1] - 2025-06-17

- Updated to `monaco-languageclient@9.7.1`.
- Updated all `@codingame/monaco-vscode` packages to `17.2.1`.

## [6.8.0] - 2025-05-28

- Updated to `monaco-languageclient@9.7.0`.
