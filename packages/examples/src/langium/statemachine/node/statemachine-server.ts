...
export const runStatemachineLanguageServer = async (messageTransports: MessageTransports) => {
  ...
  const { shared } = await createStatemachineServices({ connection, ...NodeFileSystem });
