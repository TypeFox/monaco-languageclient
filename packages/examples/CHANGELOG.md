...
## [2025.11.2-next.1] - 2025-11-20

- Updated to `monaco-languageclient@10.4.0-next.1` and `@typefox/monaco-editor-react@7.4.0-next.1`.
- Updated all `@codingame/monaco-vscode` packages to `23.1.0`.
...
- Updated to `monaco-languageclient@10.0.0` and `@typefox/monaco-editor-react@7.0.0`.
  - Align all examples with the API changes.
  - Unify single editor extended examples (json, eclipse.jdt.ls, groovy)
