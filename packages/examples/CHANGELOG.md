...
- Updated to `monaco-languageclient@8.4.0`, `monaco-editor-wrapper@4.3.0` and `@typefox/monaco-editor-react@3.3.0`. Updated all `@codingame/monaco-vscode` packages to `5.0.1`.
