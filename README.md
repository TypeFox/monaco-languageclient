...
- **monaco-languageclient**: `9.7.1` (release date: 2025-06-17)
- **monaco-editor-wrapper**: `6.8.1` (release date: 2025-06-17)
- **@typefox/monaco-editor-react**: `6.8.1` (release date: 2025-06-17)
- Aligned with:
...
When you use the libraries from this project you are no longer are required to proxy `monaco-editor` like `"monaco-editor": "npm:@codingame/monaco-vscode-editor-api@~17.2.1"` in you `package.json`. You can directly use it like this:
...
```json
"overrides": {
  "monaco-editor": "npm:@codingame/monaco-vscode-editor-api@~17.2.1"
}
```
