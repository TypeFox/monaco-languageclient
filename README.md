...
- **monaco-languageclient**: `9.9.0` (release date: 2025-08-08)
- **monaco-editor-wrapper**: `6.10.0` (release date: 2025-08-08)
- **@typefox/monaco-editor-react**: `6.10.0` (release date: 2025-08-08)
- Aligned with:
  - **@codingame/monaco-vscode-[editor]-api**: `19.1.3`
  - **vscode**: `1.102.3`
  - **monaco-editor**: `0.52.2`
- **vscode-ws-jsonrpc**: `3.5.0-next.0` (release date: 2025-08-08)
...
```json
"vscode": "npm:@codingame/monaco-vscode-extension-api@~19.1.3"
```

### @codingame/monaco-vscode-editor-api / monaco-editor usage

When you use the libraries from this project you are no longer are required to proxy `monaco-editor` like `"monaco-editor": "npm:@codingame/monaco-vscode-editor-api@~19.1.3"` in you `package.json`. You can directly use it like this:
...
```json
"overrides": {
  "monaco-editor": "npm:@codingame/monaco-vscode-editor-api@~19.1.3"
}
```
