...
- **monaco-languageclient**: `11.0.2` (release date: 2026-09-24)
- **@typefox/monaco-editor-react**: `8.0.2` (release date: 2026-09-24)
- **monaco-languageclient-examples**: private package
- Aligned with:
  - **@codingame/monaco-vscode-[editor]-api**: `37.1.0`
  - **vscode**: `1.138.0`
  - **monaco-editor**: `0.56.0`
- **vscode-ws-jsonrpc**: `4.0.2` (release date: 2026-09-24)
