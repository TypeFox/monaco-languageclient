...
```yaml
  "overrides": {
    "monaco-editor": "npm:@codingame/monaco-editor-treemended@>=1.85.0-next.1 <1.86.0",
    "vscode": "npm:@codingame/monaco-vscode-api@>=1.85.0-next.1 <1.86.0"
  },
  "resolutions": {
    "monaco-editor": "npm:@codingame/monaco-editor-treemended@>=1.85.0-next.1 <1.86.0",
    "vscode": "npm:@codingame/monaco-vscode-api@>=1.85.0-next.1 <1.86.0"
...
| :----         | :----   | :---   | :--- | :--- | :--- |
| 7.3.0         | 1.85.0  | 1.85.0 | 0.45.0 | 2023-12-1x | |
