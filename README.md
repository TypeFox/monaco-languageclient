...
Examples that don't require a backend are now available [via GitHub Pages](https://typefox.github.io/monaco-languageclient).<br>
...
- Aligned with:
  - **@codingame/monaco-vscode-[editor]-api**: `^20`
  - **vscode**: `1.103.2`
...
```json
"vscode": "npm:@codingame/monaco-vscode-extension-api@^20"
```

### @codingame/monaco-vscode-editor-api / monaco-editor usage

When you use the libraries from this project you are no longer are required to proxy `monaco-editor` like `"monaco-editor": "npm:@codingame/monaco-vscode-editor-api@^20"` in you `package.json`. You can directly use it like this:
...
```json
"overrides": {
  "monaco-editor": "npm:@codingame/monaco-vscode-editor-api@^20"
}
```
