...
When you use the libraries from this project you are no longer required to proxy `monaco-editor` like `"monaco-editor": "npm:@codingame/monaco-vscode-editor-api@^34.1.1"` in you `package.json`. You can directly use it like so:
